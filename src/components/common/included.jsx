...
function WhatIncluded() {
    return (  <section className="autogen whatincluded py-5">
    <Container>
      <Row>
        <Col md={12}>
      ...
      <Row>
        <Col md={6}>
            <strong className="pb-3 d-flex">Car component(S) covered by AUTOGEN+ </strong>
            ...
            <div className="icon-box">
                <Image src={Workshops} />
                <div className="icon-content">
                    <strong className="pb-2 d-flex">Transmission (a.k.a. Gearbox)</strong>
            ...
            <div className="icon-box">
                ...
                <div className="icon-content">
                    <strong className="pb-2">Up to RM 5,000 coverage <span>per transaction</span></strong>
                </div>
            </div>
            <div className="icon-box">
